...
const SurveyAccessMingguanButton: React.FC = () => {
  ...
  useEffect(() => {
    const fetchStatus = async () => {
      try {
        const res = await dataAPI.getSurveyStatus("mingguan");
  ...
  const toggleSurveyAccess = async () => {
    ...
    try {
      ...
      const res = await dataAPI.toggleSurveyAccess("mingguan", action);
...
export default SurveyAccessMingguanButton;
